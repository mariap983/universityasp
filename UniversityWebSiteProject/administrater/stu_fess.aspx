<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="stu_fess.aspx.cs" Inherits="administrater_stu_fees" %>
...
<div align="right">
    ...
    <div align="left" style="width: 533px">
        ...
        <table class="style1">
            ...
            <tr>
                <td align="center" colspan="2" 
                    style="background-color: #520108; color: #FFFFFF; font-weight: bold;">
                    ...
                    <asp:Button ID="Button2" runat="server" BackColor="#520108" BorderColor="White" 
...
<div style="width: 527px; height: 34px;">
    <table class="style3" style="537px; width: 525px;">
        <tr>
            <td style="color: #FFFFFF; background-color: #520108; font-weight: bold;">
                Total Fees</td>
            <td>
