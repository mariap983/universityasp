...
{
    SqlConnection cnn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\UniData.mdf;Integrated Security=True");
    ...
    protected void abc_Click(object sender, EventArgs e)
    {
        ...
        string s, i, ph, path;
        i = abc.ID;
        SqlConnection cn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\UniData.mdf;Integrated Security=True");
        ...
        if (rs.Read())
        {
            ...
            path = "D:\\UNIVERSITY\\5 семестър\\ASP I\\Second Project\\UniversityWebSiteProject_46043zkn\\UniversityWebSiteProject\\img" + ph;
            if (ph != "")
            {
                File.Delete(path);
            }
