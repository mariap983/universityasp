...
<body>
    ...
    <div style="border: 1px solid #520108; padding: 1px; margin: 1px; height: 703px; color: #000000; font-weight: bold; width: 1016px;" 
        align="right">
    <div align="center" 
            
            
            style="color: #FFFFFF; background-color: #520108; font-weight: bold; height: 35px; bottom: 3px;">

        STUDENT REGISTRATION FORM</div>
        <div style="background-color: #520108">
    ...
    <div style="width: 234px; height: 35px;" align="left">
        ...
        <asp:TextBox ID="mob" onkeypress="return isNumber(event)" runat="server" Width="205px" BorderColor="#000000" 
            BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
    ...
    <div style="width: 234px; height: 35px; float: left;" align="left">
        ...
        <asp:TextBox ID="dob" runat="server" Width="198px" BorderColor="#000000" 
            BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
    ...
    <div style="width: 234px; height: 35px;" align="left">
        ...
        <asp:TextBox ID="doa" runat="server" Width="205px" BorderColor="#000000" 
            BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>

        </div>
        <div align="center" style="color: #FFFFFF; background-color: #520108">HIGH SCOOL 
            INFORMATION</div>
            <div style="width: 234px; height: 35px; float: left;" align="left">
    ...
    <div style="width: 234px; height: 35px;" align="left">
        ...
        <div align="center" style="color: #FFFFFF; background-color: #520108">INTERMEDIATE 
            INFORMATION</div>
            <div style="width: 234px; height: 35px; float: left;" align="left">
    ...
    <div style="width: 234px; height: 35px;" align="left">
        ...
        <div style="width: 1014px; height: 35px; float: left;" align="center">
            ...
            <asp:Button ID="update" runat="server" Text="Update" BackColor="#520108" 
                BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" ForeColor="#FFFFCC" 
                Visible="False" onclick="update_Click" />
            <asp:Button ID="Button5" runat="server" BackColor="#520108" BorderStyle="Solid" 
                BorderWidth="0px" Font-Bold="True" ForeColor="White" onclick="Button5_Click" 
                Text="save" style="height: 22px" />
            <asp:Button ID="Button3" runat="server" Text="Reset" BackColor="#520108" 
                BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" ForeColor="White" 
                onclick="Button3_Click" />
            <asp:Button ID="Button4" runat="server" BackColor="#520108" BorderStyle="Solid" 
