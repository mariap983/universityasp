    ...
    <div style="height: 624px">
            ...
            <table class="style1" id="table1">
                <tr>
                    <td align="center" bgcolor="White" colspan="3" 
                        ...
                        style="color: #FFFFFF; font-weight: bold; font-size: large; background-color: #520108;">
                        Modify Address</td>
                </tr>
                <tr>
                    <td align="center" 
                ...
                <tr>
                    ...
                    <td align="center">
                        <asp:Button ID="Button8" runat="server" BackColor="#520108" BorderStyle="Solid" 
                    BorderWidth="1px" Font-Bold="True" ForeColor="White" Text="Add" Visible="False" 
                            onclick="Button8_Click" />
                    </td>
                    <td align="center">
                        <asp:Button ID="Button9" runat="server" BackColor="#520108" BorderStyle="Solid" 
                    BorderWidth="1px" Font-Bold="True" ForeColor="White" Text="Add" Visible="False" 
                            onclick="Button9_Click" />
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="background-color: #520108" width="2">
                        &nbsp;</td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <asp:Panel ID="Panel2" runat="server" Visible="False">
            <table class="style1" id="table2">
                ...
                <tr>
                    <td align="left" 
                style="color: #000000; font-weight: bold" class="style5">
                        New Course</td>
                    <td align="left" class="style5" style="color: #000000; font-weight: bold">
                        Update</td>
                    <td align="center">
                ...
                <tr>
                    <td align="left" class="style4" style="color: #000000; font-weight: bold">
                        <asp:RadioButtonList ID="qul1" runat="server" AutoPostBack="True" 
                            Font-Bold="True" ForeColor="#000000" Visible="False">
    ...
    <br />
        <asp:Panel ID="Panel3" runat="server" Height="158px" Visible="False">
            <table class="style1" id="table3">
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="Button10" runat="server" BackColor="#520108" 
                    BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" ForeColor="White" 
                    Text="Add" onclick="Button10_Click" />
                        <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                    </td>
                    <td align="center">
                        <asp:Button ID="Button11" runat="server" BackColor="#520108" 
                    BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" ForeColor="White" 
                    Text="Add" onclick="Button11_Click" />
                        <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
                    </td>
                    <td align="center">
                        <asp:Button ID="Button12" runat="server" BackColor="#520108" 
                    BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" ForeColor="White" 
                ...
                <tr>
                    <td colspan="3" style="background-color: #520108" align="center">
                        &nbsp;</td>
                </tr>
            </table>
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button13" runat="server" BorderColor="White" 
            BorderStyle="Solid" Font-Bold="True" ForeColor="#520108" 
