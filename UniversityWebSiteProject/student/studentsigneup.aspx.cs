    ...
    {
        {
            ...
            {
                String dr, f_name, l_name, email, gender, u_id, u_pass, c_pass, s, mobi, s1;
                int x = 0, c = 0;
                ...
                dr = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\\UniData.mdf;Integrated Security=True";
