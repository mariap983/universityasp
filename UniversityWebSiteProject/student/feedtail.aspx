...
<div style="width: 527px; height: 25px;">
    ...
    <div align="center" style="height: 37px">
            ...
            <asp:Button ID="btnPrint" runat="server" Text="Print" 
                OnClientClick = "return PrintPanel();" BackColor="White" BorderColor="#520108" 
                BorderStyle="Solid" Font-Bold="True" ForeColor="#520108" />

        <asp:Button ID="Button2" runat="server" BorderColor="#520108" 
            BorderStyle="Solid" Font-Bold="True" ForeColor="#520108" Text="Back" 
