...
<form id="form1">
    <div align="center" style="height: 469px"> 
      <div 
            ...
            style="height: 44px; width: 709px; font-size: xx-large; font-weight: bold; color: #FFFFFF; background-color: #520108; text-decoration: underline blink;" 
            align="center">
          SIGNUP</div>
              <div style="width: 353px; font-size: large; font-weight: bold; color: #000000; float: left;" align="right" 
            >
                  First Name</div>
        <div 
                      
            style="width: 283px; font-size: large; font-weight: bold; color: #000000;">
                  &nbsp;
...
Width="197px"></asp:TextBox>
        ...
        <div 
            ...
            style="width: 353px; font-size: large; font-weight: bold; color: #000000; float: left;" align="right" 
            >
                  Last name</div><div 
            ...
            style="width: 283px; font-size: large; font-weight: bold; color: #000000;">
                  ...
                  <asp:TextBox ID="mob" onkeypress="return isNumber(event)" runat="server"
                      Width="197px" AutoPostBack="True"></asp:TextBox>
        </div><div 
        ...
        <div 
            ...
            style="font-size: large; font-weight: bold; color: #000000; float: left; width: 353px;" align="right" 
           >
