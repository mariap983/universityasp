...
<form id="form1">
    ...
    <div align="center" 
            ...
            style="color: #FFFFFF; background-color: #520108; font-weight: bold; font-size: xx-large; width: 878px;">
        STUDENT LOGGED</div>
        <div align="right" style="background-color: #520108; width: 878px;">
...
&nbsp;&nbsp;&nbsp;
            <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="True" OnClick="LinkButton3_Click">Query</asp:LinkButton>
        </div>
